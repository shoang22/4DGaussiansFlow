...
class Camera(nn.Module):
    def __init__(self, colmap_id, R, T, FoVx, FoVy, image, gt_alpha_mask,
        ...
        self.intrinsic = getIntrinsicMatrix(width=self.image_width, height=self.image_height, fovX=self.FoVx, fovY=self.FoVy)
        self.extrinsic = torch.tensor(getExtrinsicMatrix(R, T))
